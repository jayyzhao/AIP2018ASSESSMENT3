        ...
        <div className="album py-5 bg-light">
          <div className="row">
            ...
            <Modal style={customStyles}
                ...
                <div style={{borderBottom:"2px dotted #B5ABAB",fontFamily:'Arial,Verdana,Sans-serif'}} ><h2 style={{}}>{meal.MEAL_NAME}<span style={priceStyles}>${meal.MEAL_UNIT_PRICE}</span></h2><br/></div>
                )}
            </Modal>
          </div>
        </div>
